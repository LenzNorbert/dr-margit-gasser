...
export const Navbar = ({ menuHeadline, menuItems, flipScrollmode }: NavbarProps) => {
  ...
  return (
    <>
      <button className="fixed right-0 z-50 h-20 w-20 p-4 xl:hidden" onClick={() => onClick(!openMenu)}>
      ...
      <div
        ...
        } lg:delay-600 z-50 bg-cpBeige transition-all xl:border-b-[1px] xl:border-cpDark
        `}>
